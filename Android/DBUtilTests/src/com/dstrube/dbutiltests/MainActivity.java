package com.dstrube.dbutiltests;
...
//import com.dstrube.dbutil.TableColumnList;
//import com.dstrube.dbutil.Utils;
//import com.dstrube.dbutil.UtilsException;
import com.dstrube.dbutil.*;
...
public class MainActivity extends Activity {
	...
	private boolean testTableNames(boolean display) {
		try {
			...
			ArrayList<String> tableNamesIn = new ArrayList<String>();
	...
	private boolean testColumns(boolean display) {
		try {
			...
			ArrayList<TableColumnList> columnsIn = new ArrayList<TableColumnList>();
	...
	private boolean testInsert() {
		try {
			...
			Hashtable<String, String> queryValues = new Hashtable<String, String>();
