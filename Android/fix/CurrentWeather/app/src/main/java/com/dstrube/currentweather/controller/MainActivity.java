...
public class MainActivity extends AppCompatActivity {
    ...
    private void setTodayAdapterAndListener() {
        final CustomAdapterToday adapterToday = new CustomAdapterToday(this, dataToday, R.layout.big_day,
    ...
    private void set5DayAdapterAndListener() {
        CustomAdapter5Day adapter5Day = new CustomAdapter5Day(this, data5Days, R.layout.little_day,
