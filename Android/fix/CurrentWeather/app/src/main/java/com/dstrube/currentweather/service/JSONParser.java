...
public class JSONParser {
    ...
    public JSONObject getJSONFromUrl(final String urlParam, final Context context) {
        ...
        try {
            ...
            Log.e(TAG, getClass().getEnclosingMethod().getName() + ": IOException");
        }
    ...
    private String readStream(final InputStream in) {
        ...
        try {
            ...
            Log.e(TAG, getClass().getEnclosingMethod().getName() + ": IOException while reading");
        } finally {
            if (reader != null) {
                try {
                    reader.close();
                } catch (IOException e) {
                    Log.e(TAG, getClass().getEnclosingMethod().getName() + ": IOException while closing");
                }
            }
        }
