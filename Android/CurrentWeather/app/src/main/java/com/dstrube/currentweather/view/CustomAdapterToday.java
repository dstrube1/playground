...
//        this.data = (ArrayList<HashMap<String, String>>)data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final TextView todayDate = (TextView) view.findViewById(R.id.big_day_date);
        final TextView todayHigh = (TextView) view.findViewById(R.id.big_day_temp_high);
        final TextView todayLow = (TextView) view.findViewById(R.id.big_day_temp_low);
        final TextView todayDescription = (TextView) view.findViewById(R.id.big_day_description);
        ...
        final ImageView imageView = (ImageView) view.findViewById(R.id.big_day_image);
        imageView.setImageDrawable(top);

//tried this, didn't show
//        todayDescription.setCompoundDrawables(null, top, null, null);
        final TextView humidity = (TextView) view.findViewById(R.id.big_day_humidity);
        final TextView pressure = (TextView) view.findViewById(R.id.big_day_pressure);
        final TextView wind = (TextView) view.findViewById(R.id.big_day_wind);
        final TextView degree = (TextView) view.findViewById(R.id.big_day_degree);
        final TextView icon = (TextView) view.findViewById(R.id.big_day_icon);
